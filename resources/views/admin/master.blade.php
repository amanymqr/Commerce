...
<head>
    ...
    @if(app()->currentLocale()=='ar')
        <style>
            @import url('https://fonts.googleapis.com/css2?family=Almarai&family=Caveat:wght@400;500;600&family=Indie+Flower&family=Poppins:ital,wght@0,100;0,300;0,400;0,500;0,600;1,700&display=swap');
            body{
                direction:rtl;
                text-align:right;
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseCatygo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Languges ({{ app()->currentLocale() }})</span>
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                    <a class="dropdown-item " rel="alternate" hreflang="{{ $localeCode }}"
                                        ...
                                        <img width="18" class="mx-1" src="{{ asset('adminassets/img/' . $properties['flag']) }}"
                                            alt="">
                                        {{ $properties['native'] }}
                                    </a>
